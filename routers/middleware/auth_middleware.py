...
from config import ACCESS_TOKEN_SECRET, ALGORITHM   # ✅ import from central config
...
async def get_user_by_id(user_id: str) -> dict | None:
    ...
    fake_db = {
        "1": {"id": "1", "email": "test@example.com", "last_sign_in": "2024-01-01T10:00:00"}
    }
    return fake_db.get(str(user_id))