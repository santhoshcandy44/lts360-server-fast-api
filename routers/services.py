...
async def guest_get_user_profile_and_services_by_user_id(
    request: Request,
    query:   GetUserProfileServicesSchema = Depends(),
    db:      AsyncSession = Depends(get_db),
):
    return await service_controller.guest_get_user_profile_and_services_by_user_id(request, schema, query, db)
...
async def guest_get_services_by_user_id(
    ...
    return await service_controller.guest_get_services_by_user_id(request, schema, query, db)
...
async def guest_get_service_by_service_id(
    ...
    return await service_controller.guest_get_service_by_service_id(request, schema, db)
...
async def get_me_services(
    request: Request,
    schema:  GetMeServicesSchema = Depends(),
    db:      AsyncSession = Depends(get_db),
    _:       None = Depends(authenticate_token),
):
    return await service_controller.get_me_services(request, schema, db)
